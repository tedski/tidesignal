...
import com.tidesignal.data.TideDatabase
import com.tidesignal.tide.HarmonicCalculator
import com.tidesignal.tide.TideCache
 ...
 */
class TideSignalApplication : Application() {
 ...
 */
val Context.dataStore: DataStore<Preferences> by preferencesDataStore(name = "tidesignal_preferences")
