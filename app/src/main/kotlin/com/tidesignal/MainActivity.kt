...
import com.tidesignal.data.PreferencesRepository
import com.tidesignal.data.StationRepository
import com.tidesignal.ui.app.SettingsScreen
import com.tidesignal.ui.app.StationPickerScreen
import com.tidesignal.ui.app.TideDetailScreen
import com.tidesignal.ui.app.TideMainScreen
import com.tidesignal.ui.theme.TideSignalTheme

/**
 * Main activity for TideSignal app.
 *
...
class MainActivity : FragmentActivity(), AmbientModeSupport.AmbientCallbackProvider {
    ...
    private val viewModel: TideViewModel by viewModels {
        val app = application as TideSignalApplication
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            TideSignalTheme(isAmbient = isAmbient.value) {
                TideSignalApp(
                    viewModel = viewModel,
...
class TideViewModelFactory(
    ...
    private val application: TideSignalApplication,
